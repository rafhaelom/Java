...
public class Janela02_2 extends JFrame{
    
    private JLabel lb_im;
    
    public Janela02_2(){
        super("Janela02_2 - JLabel Texto e Imagem"); //Titulo Janela.
        ...
        lb_im = new JLabel("Penguins", imagem, SwingConstants.CENTER);
        lb_im.setHorizontalTextPosition( SwingConstants.CENTER );
        lb_im.setVerticalTextPosition( SwingConstants.BOTTOM );
    ...
    public static void main(String [] args){
        new Janela02_2().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    }
}
